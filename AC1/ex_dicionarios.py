...
def conta_telefones(agenda):
    ...
    for contato in agenda:
        conta_telefones += len(agenda[contato]['telefones'])
        # for telefone in agenda[contato]['telefones']:
            

    return conta_telefones
...
def conta_ocorrencias(agenda):
    ...
    for contato in agenda:
        for telefone in agenda[contato]['telefones']:
            if telefone in conta_ocorrencias:
                conta_ocorrencias[telefone] += 1
            else:
                conta_ocorrencias[telefone] = 1
    return conta_ocorrencias